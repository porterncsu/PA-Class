...
cat("Saved sampled dataset to:", sample_path, "\n")
...
Let's examine the inspection results distribution. This shows us the balance of inspection outcomes, which is important for understanding the baseline rate and potential modeling challenges.
...
Now let's look at the facility types to understand what kinds of establishments are being inspected.
...
Let's also look at the types of inspections conducted.
...
**Text Data**: The violations column contains rich free-text information, which may present some fun opporutunities to incorporate AI into your workflow - I don't know how successful you will be, but it could be fun to try, and I'm happy to discuss ideas in class and outside of class as well. 
